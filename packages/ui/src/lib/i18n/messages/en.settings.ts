...
export const settingsDict = {
  ...
  'settings.page.pets.title': 'Pets',
  'settings.page.pets.description': 'Choose whether to show your pet companion.',
  'settings.page.pets.section.pet': 'Pet Companion',
  'settings.page.pets.choosePet': 'Choose Pet…',
  ...
  'settings.page.pets.action.create': 'Create a Pet',
  'settings.page.pets.action.select': 'Select',
  'settings.page.pets.action.selected': 'Selected',
  'settings.page.pets.action.refresh': 'Refresh',
  'settings.page.pets.action.wake': 'Wake Up',
  'settings.page.pets.action.dismiss': 'Hide Pet',
  ...
  'settings.notifications.page.sounds.title': "Sound Effects",
  'settings.notifications.page.sounds.description': "Play sounds when notification events occur.",
  'settings.notifications.page.sounds.agent.title': "Agent",
  'settings.notifications.page.sounds.agent.description': "Play sound when the agent is complete or needs attention.",
