...
export const dict = {
  ...
  'chat.commandAutocomplete.command.petsDescription': 'Show or hide a pet companion, or switch to another pet by name.',
  'chat.pets.state.running': 'Running',
  'chat.pets.state.needsInput': 'Needs input',
  'chat.pets.state.ready': 'Ready',
  'chat.pets.state.blocked': 'Blocked',
  'chat.pets.loading': 'Loading pet…',
  'chat.pets.unavailable': 'Pet unavailable',
  'chat.pets.picker.title': 'Pets',
  'chat.pets.picker.disabledItem': 'Disabled',
  'chat.pets.picker.loadingPreview': 'Loading preview...',
  'chat.pets.picker.disabledTitle': 'Terminal pets disabled',
  'chat.pets.picker.disabledBody': 'No pet will be shown.',
  'chat.pets.picker.previewError': 'Preview unavailable',
  'chat.pets.picker.select': 'Select',
  'chat.pets.description.codex': 'The original Codex companion',
  'chat.pets.description.dewey': 'A tidy duck for calm workspace days',
  'chat.pets.description.fireball': 'Hot path energy for fast iteration',
  'chat.pets.description.rocky': 'A steady rock when the diff gets large',
  'chat.pets.description.seedy': 'Small green shoots for new ideas',
  'chat.pets.description.stacky': 'A balanced stack for deep work',
  'chat.pets.description.bsod': 'A tiny blue-screen gremlin',
  'chat.pets.description.nullSignal': 'Quiet signal from the void',
  ...
  'chat.chatInput.toast.questionDismissFailed': 'Could not dismiss the pending question. Please answer it first and try again.',
  'chat.chatInput.toast.permissionDismissFailed': 'Could not dismiss the pending permission. Please handle it first and try again.',
