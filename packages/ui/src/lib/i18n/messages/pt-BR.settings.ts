...
export const settingsDict = {
  ...
  "settings.page.pets.title": "Animais de estimação",
  "settings.page.pets.description": "Escolha se deseja exibir seu animal de estimação.",
  "settings.page.pets.section.pet": "Animal de estimação",
  "settings.page.pets.choosePet": "Escolher animal…",
  ...
  "settings.page.pets.action.create": "Criar um pet",
  "settings.page.pets.action.select": "Selecionar",
  "settings.page.pets.action.selected": "Selecionado",
  "settings.page.pets.action.refresh": "Atualizar",
  "settings.page.pets.action.wake": "Acordar",
  "settings.page.pets.action.dismiss": "Ocultar mascote",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.field.showPetAria": "Mostrar o companheiro",
  "settings.openchamber.visual.field.showPet": "Mostrar companheiro",
  ...
  'settings.notifications.page.sounds.title': "Efeitos sonoros",
  'settings.notifications.page.sounds.description': "Reproduzir sons quando ocorrerem eventos de notificação.",
  'settings.notifications.page.sounds.agent.title': "Agente",
  'settings.notifications.page.sounds.agent.description': "Reproduzir som quando o agente terminar ou precisar de atenção.",
  'settings.notifications.page.sounds.permissions.title': "Permissões",
