...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.commandAutocomplete.command.petsDescription": "Mostrar ou ocultar um companheiro, ou alternar para outro pelo nome.",
  "chat.pets.state.running": "Em execução",
  "chat.pets.state.needsInput": "Aguarda entrada",
  "chat.pets.state.ready": "Pronto",
  "chat.pets.state.blocked": "Bloqueado",
  "chat.pets.loading": "Carregando companheiro…",
  "chat.pets.unavailable": "Companheiro indisponível",
  "chat.pets.picker.title": "Companheiros",
  "chat.pets.picker.disabledItem": "Desativado",
  "chat.pets.picker.loadingPreview": "Carregando a prévia...",
  "chat.pets.picker.disabledTitle": "Companheiros de terminal desativados",
  "chat.pets.picker.disabledBody": "Nenhum companheiro será exibido.",
  "chat.pets.picker.previewError": "Prévia indisponível",
  "chat.pets.picker.select": "Selecionar",
  "chat.pets.description.codex": "O companheiro Codex original",
  "chat.pets.description.dewey": "Um pato arrumado para dias calmos",
  "chat.pets.description.fireball": "Energia para iterações rápidas",
  "chat.pets.description.rocky": "Uma rocha firme quando o diff cresce",
  "chat.pets.description.seedy": "Pequenos brotos verdes para novas ideias",
  "chat.pets.description.stacky": "Uma pilha equilibrada para trabalho profundo",
  "chat.pets.description.bsod": "Um pequeno duende de tela azul",
  "chat.pets.description.nullSignal": "Um sinal silencioso do vazio",
  ...
  "chat.chatInput.toast.questionDismissFailed": "Não foi possível descartar a pergunta pendente. Responda primeiro e tente novamente.",
  "chat.chatInput.toast.permissionDismissFailed": "Não foi possível descartar a permissão pendente. Trate primeiro e tente novamente.",
