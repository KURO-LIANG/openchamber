...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.commandAutocomplete.command.petsDescription': '显示或隐藏宠物伙伴，或按名称切换到另一只宠物。',
  'chat.pets.state.running': '运行中',
  'chat.pets.state.needsInput': '等待输入',
  'chat.pets.state.ready': '已完成',
  'chat.pets.state.blocked': '受阻',
  'chat.pets.loading': '宠物加载中…',
  'chat.pets.unavailable': '宠物不可用',
  'chat.pets.picker.title': '宠物',
  'chat.pets.picker.disabledItem': '已禁用',
  'chat.pets.picker.loadingPreview': '预览加载中...',
  'chat.pets.picker.disabledTitle': '终端宠物已禁用',
  'chat.pets.picker.disabledBody': '不会显示宠物。',
  'chat.pets.picker.previewError': '预览不可用',
  'chat.pets.picker.select': '选择',
  'chat.pets.description.codex': '最初的 Codex 伙伴',
  'chat.pets.description.dewey': '安宁静心工作日的整洁小鸭',
  'chat.pets.description.fireball': '快速迭代的热路径能量',
  'chat.pets.description.rocky': 'diff 变大时的稳固磐石',
  'chat.pets.description.seedy': '为新想法而生的小绿芽',
  'chat.pets.description.stacky': '深度工作的均衡堆栈',
  'chat.pets.description.bsod': '小小的蓝屏小恶魔',
  'chat.pets.description.nullSignal': '来自虚空的静谧信号',
