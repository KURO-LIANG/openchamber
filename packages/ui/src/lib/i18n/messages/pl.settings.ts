...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.showPetAria': 'Pokaż towarzysza-peta',
  'settings.openchamber.visual.field.showPet': 'Pokaż towarzysza-peta',
  ...
  'settings.page.pets.title': 'Zwierzątka',
  'settings.page.pets.description': 'Wybierz, czy chcesz wyświetlać swojego towarzysza-zwierzątko.',
  'settings.page.pets.section.pet': 'Zwierzątko-towarzysz',
  'settings.page.pets.choosePet': 'Wybierz zwierzątko…',
  ...
  'settings.page.pets.action.create': 'Utwórz zwierzątko',
  'settings.page.pets.action.select': 'Wybierz',
  'settings.page.pets.action.selected': 'Wybrane',
  'settings.page.pets.action.refresh': 'Odśwież',
  'settings.page.pets.action.wake': 'Obudź',
  'settings.page.pets.action.dismiss': 'Ukryj zwierzaka',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.notifications.page.sounds.title': "Efekty dźwiękowe",
  'settings.notifications.page.sounds.description': "Odtwarzaj dźwięki, gdy wystąpią zdarzenia powiadomień.",
  'settings.notifications.page.sounds.agent.title': "Agent",
  'settings.notifications.page.sounds.agent.description': "Odtwórz dźwięk, gdy agent zakończy pracę lub wymaga uwagi.",
  'settings.notifications.page.sounds.permissions.title': "Uprawnienia",
