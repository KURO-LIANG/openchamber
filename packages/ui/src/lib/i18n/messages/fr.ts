...
export const dict = {
  ...
  'chat.commandAutocomplete.command.petsDescription': 'Afficher ou masquer un compagnon, ou passer à un autre compagnon par nom.',
  'chat.pets.state.running': 'En cours',
  'chat.pets.state.needsInput': 'Réponse requise',
  'chat.pets.state.ready': 'Prêt',
  'chat.pets.state.blocked': 'Bloqué',
  'chat.pets.loading': 'Chargement du compagnon…',
  'chat.pets.unavailable': 'Compagnon indisponible',
  'chat.pets.picker.title': 'Compagnons',
  'chat.pets.picker.disabledItem': 'Désactivé',
  'chat.pets.picker.loadingPreview': 'Chargement de l\'aperçu...',
  'chat.pets.picker.disabledTitle': 'Compagnons de terminal désactivés',
  'chat.pets.picker.disabledBody': 'Aucun compagnon ne sera affiché.',
  'chat.pets.picker.previewError': 'Aperçu indisponible',
  'chat.pets.picker.select': 'Sélectionner',
  'chat.pets.description.codex': 'Le compagnon Codex d\'origine',
  'chat.pets.description.dewey': 'Un canard soigné pour des journées calmes',
  'chat.pets.description.fireball': 'De l\'énergie pour des itérations rapides',
  'chat.pets.description.rocky': 'Un roc stable quand la diff grossit',
  'chat.pets.description.seedy': 'De petites pousses vertes pour de nouvelles idées',
  'chat.pets.description.stacky': 'Une pile équilibrée pour le travail en profondeur',
  'chat.pets.description.bsod': 'Un petit lutin d\'écran bleu',
  'chat.pets.description.nullSignal': 'Un signal discret venu du vide',
