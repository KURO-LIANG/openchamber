...
export const settingsDict = {
  ...
  "settings.page.pets.title": "Mascotas",
  "settings.page.pets.description": "Elige si quieres mostrar tu mascota compañera.",
  "settings.page.pets.section.pet": "Mascota compañera",
  "settings.page.pets.choosePet": "Elegir mascota…",
  ...
  "settings.page.pets.action.create": "Crear una mascota",
  "settings.page.pets.action.select": "Seleccionar",
  "settings.page.pets.action.selected": "Seleccionado",
  "settings.page.pets.action.refresh": "Actualizar",
  "settings.page.pets.action.wake": "Despertar",
  "settings.page.pets.action.dismiss": "Ocultar mascota",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.field.showPetAria": "Mostrar el compañero",
  "settings.openchamber.visual.field.showPet": "Mostrar compañero",
  ...
  'settings.notifications.page.sounds.title': "Efectos de sonido",
  'settings.notifications.page.sounds.description': "Reproducir sonidos cuando ocurran eventos de notificación.",
  'settings.notifications.page.sounds.agent.title': "Agente",
  'settings.notifications.page.sounds.agent.description': "Reproducir sonido cuando el agente termine o necesite atención.",
  'settings.notifications.page.sounds.permissions.title': "Permisos",
  'settings.notifications.page.sounds.permissions.description': "Reproducir sonido cuando se requiera un permiso.",
  'settings.notifications.page.sounds.errors.title': "Errores",
  'settings.notifications.page.sounds.errors.description': "Reproducir sonido cuando ocurra un error.",
  'settings.notifications.page.sounds.questions.title': "Preguntas",
  'settings.notifications.page.sounds.questions.description': "Reproducir sonido cuando el agente te haga una pregunta.",
  'settings.notifications.page.sounds.option.none': "Ninguno",
