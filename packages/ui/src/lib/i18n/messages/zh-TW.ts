...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.commandAutocomplete.command.petsDescription': '顯示或隱藏寵物夥伴，或按名稱切換到另一隻寵物。',
  'chat.pets.state.running': '執行中',
  'chat.pets.state.needsInput': '等待輸入',
  'chat.pets.state.ready': '已完成',
  'chat.pets.state.blocked': '受阻',
  'chat.pets.loading': '寵物載入中…',
  'chat.pets.unavailable': '寵物不可用',
  'chat.pets.picker.title': '寵物',
  'chat.pets.picker.disabledItem': '已停用',
  'chat.pets.picker.loadingPreview': '預覽載入中...',
  'chat.pets.picker.disabledTitle': '終端寵物已停用',
  'chat.pets.picker.disabledBody': '不會顯示寵物。',
  'chat.pets.picker.previewError': '預覽不可用',
  'chat.pets.picker.select': '選擇',
  'chat.pets.description.codex': '最初的 Codex 夥伴',
  'chat.pets.description.dewey': '寧靜工作日的整潔小鴨',
  'chat.pets.description.fireball': '快速迭代的熱路徑能量',
  'chat.pets.description.rocky': 'diff 變大時的穩固磐石',
  'chat.pets.description.seedy': '為新想法而生的小綠芽',
  'chat.pets.description.stacky': '深度工作的均衡堆疊',
  'chat.pets.description.bsod': '小小的藍屏小惡魔',
  'chat.pets.description.nullSignal': '來自虛空的靜謐訊號',
  ...
  'chat.chatInput.toast.questionDismissFailed': '無法關閉會話中的待處理問題，請先回答問題後再試。',
  'chat.chatInput.toast.permissionDismissFailed': '無法關閉會話中的待處理權限，請先處理後再試。',
