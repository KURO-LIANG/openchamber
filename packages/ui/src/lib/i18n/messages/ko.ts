...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.commandAutocomplete.command.petsDescription': '펫 동반자를 표시하거나 숨기거나 이름으로 다른 펫으로 전환합니다.',
  'chat.pets.state.running': '실행 중',
  'chat.pets.state.needsInput': '입력 필요',
  'chat.pets.state.ready': '완료',
  'chat.pets.state.blocked': '차단됨',
  'chat.pets.loading': '펫 불러오는 중…',
  'chat.pets.unavailable': '펫을 사용할 수 없음',
  'chat.pets.picker.title': '펫',
  'chat.pets.picker.disabledItem': '사용 안 함',
  'chat.pets.picker.loadingPreview': '미리보기 불러오는 중...',
  'chat.pets.picker.disabledTitle': '터미널 펫이 사용 중지되었습니다',
  'chat.pets.picker.disabledBody': '펫이 표시되지 않습니다.',
  'chat.pets.picker.previewError': '미리보기를 사용할 수 없음',
  'chat.pets.picker.select': '선택',
  'chat.pets.description.codex': '최초의 Codex 동반자',
  'chat.pets.description.dewey': '조용한 작업 공간을 위한 단정한 오리',
  'chat.pets.description.fireball': '빠른 반복을 위한 핫 패스 에너지',
  'chat.pets.description.rocky': '큰 diff 앞에서도 흔들리지 않는 바위',
  'chat.pets.description.seedy': '새로운 아이디어를 위한 작은 새싹',
  'chat.pets.description.stacky': '깊은 작업을 위한 균형 잡힌 스택',
  'chat.pets.description.bsod': '작은 블루스크린 도깨비',
  'chat.pets.description.nullSignal': '공허에서 온 고요한 신호',
  ...
  'chat.chatInput.toast.questionDismissFailed': '보류 중인 질문을 닫을 수 없습니다. 먼저 질문에 답한 후 다시 시도하세요.',
  'chat.chatInput.toast.permissionDismissFailed': '보류 중인 권한을 닫을 수 없습니다. 먼저 권한을 처리한 후 다시 시도하세요.',
