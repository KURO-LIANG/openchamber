...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.commandAutocomplete.command.petsDescription": "Mostrar u ocultar un compañero, o cambiar a otro por nombre.",
  "chat.pets.state.running": "En curso",
  "chat.pets.state.needsInput": "Se necesita entrada",
  "chat.pets.state.ready": "Listo",
  "chat.pets.state.blocked": "Bloqueado",
  "chat.pets.loading": "Cargando compañero…",
  "chat.pets.unavailable": "Compañero no disponible",
  "chat.pets.picker.title": "Compañeros",
  "chat.pets.picker.disabledItem": "Desactivado",
  "chat.pets.picker.loadingPreview": "Cargando la vista previa...",
  "chat.pets.picker.disabledTitle": "Compañeros de terminal desactivados",
  "chat.pets.picker.disabledBody": "No se mostrará ningún compañero.",
  "chat.pets.picker.previewError": "Vista previa no disponible",
  "chat.pets.picker.select": "Seleccionar",
  "chat.pets.description.codex": "El compañero Codex original",
  "chat.pets.description.dewey": "Un pato pulcro para días tranquilos",
  "chat.pets.description.fireball": "Energía para iteraciones rápidas",
  "chat.pets.description.rocky": "Una roca firme cuando el diff crece",
  "chat.pets.description.seedy": "Pequeños brotes verdes para nuevas ideas",
  "chat.pets.description.stacky": "Una pila equilibrada para trabajo profundo",
  "chat.pets.description.bsod": "Un pequeño duende de pantalla azul",
  "chat.pets.description.nullSignal": "Una señal silenciosa del vacío",
  ...
  "chat.chatInput.toast.questionDismissFailed": "No se pudo descartar la pregunta pendiente. Respóndela primero e inténtalo de nuevo.",
  "chat.chatInput.toast.permissionDismissFailed": "No se pudo descartar el permiso pendiente. Trátalo primero e inténtalo de nuevo.",
