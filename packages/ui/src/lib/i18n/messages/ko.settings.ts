...
export const settingsDict = {
  ...
  'settings.page.pets.title': '반려동물',
  'settings.page.pets.description': '반려동물 컴패니언을 표시할지 선택하세요.',
  'settings.page.pets.section.pet': '반려동물 컴패니언',
  'settings.page.pets.choosePet': '반려동물 선택…',
  ...
  'settings.page.pets.action.create': '반려동물 만들기',
  'settings.page.pets.action.select': '선택',
  'settings.page.pets.action.selected': '선택됨',
  'settings.page.pets.action.refresh': '새로고침',
  'settings.page.pets.action.wake': '깨우기',
  'settings.page.pets.action.dismiss': '펫 숨기기',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.showPetAria': '펫 동반자 표시',
  'settings.openchamber.visual.field.showPet': '펫 동반자 표시',
  ...
  'settings.notifications.page.sounds.title': "효과음",
  'settings.notifications.page.sounds.description': "알림 이벤트가 발생할 때 소리를 재생합니다.",
  'settings.notifications.page.sounds.agent.title': "에이전트",
  'settings.notifications.page.sounds.agent.description': "에이전트가 완료되거나 주의가 필요할 때 소리 재생.",
  'settings.notifications.page.sounds.permissions.title': "권한",
