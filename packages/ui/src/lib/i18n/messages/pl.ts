...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.commandAutocomplete.command.petsDescription': 'Pokaż lub ukryj towarzysza-peta lub przełącz na innego po nazwie.',
  'chat.pets.state.running': 'Działa',
  'chat.pets.state.needsInput': 'Wymaga danych',
  'chat.pets.state.ready': 'Gotowy',
  'chat.pets.state.blocked': 'Zablokowany',
  'chat.pets.loading': 'Wczytywanie peta…',
  'chat.pets.unavailable': 'Pet niedostępny',
  'chat.pets.picker.title': 'Pety',
  'chat.pets.picker.disabledItem': 'Wyłączone',
  'chat.pets.picker.loadingPreview': 'Wczytywanie podglądu...',
  'chat.pets.picker.disabledTitle': 'Pety terminala wyłączone',
  'chat.pets.picker.disabledBody': 'Żaden pet nie będzie wyświetlany.',
  'chat.pets.picker.previewError': 'Podgląd niedostępny',
  'chat.pets.picker.select': 'Wybierz',
  'chat.pets.description.codex': 'Pierwotny towarzysz Codex',
  'chat.pets.description.dewey': 'Schludna kaczka na spokojne dni pracy',
  'chat.pets.description.fireball': 'Energia na szybkie iteracje',
  'chat.pets.description.rocky': 'Solidna skała, gdy diff rośnie',
  'chat.pets.description.seedy': 'Małe zielone pędy na nowe pomysły',
  'chat.pets.description.stacky': 'Zrównoważony stos do głębokiej pracy',
  'chat.pets.description.bsod': 'Mały chochlik niebieskiego ekranu',
  'chat.pets.description.nullSignal': 'Cichy sygnał z pustki',
  ...
  'chat.chatInput.toast.questionDismissFailed': 'Nie udało się zamknąć oczekującego pytania. Najpierw odpowiedz na pytanie i spróbuj ponownie.',
  'chat.chatInput.toast.permissionDismissFailed': 'Nie udało się zamknąć oczekującego żądania uprawnień. Najpierw je obsłuż i spróbuj ponownie.',
